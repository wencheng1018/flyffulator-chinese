            ...
            <div className="chart-title">
                {
                    skillProp != null && (
                        ...
                        (() => {
                            ...
                            return (
                                <img className="chart-icon" src={`https://api.flyff.com/image/skill/colored/${skillProp.icon}`} alt={skillProp.name[skillLangKey] ?? skillProp.name.en} />
                            );
                        })()
                    )
                }
                                    ...
                                    if (data.afterDamageProps) {
                                        ...
                                        if (data.afterDamageProps.triggeredSkill) {
                                            ...
                                            if (skillProp) {
                                                ...
                                                out += `(Triggered ${skillProp.name[skillLangKey] ?? skillProp.name.en})\n`;
                                            }
                                        }
                                    }
