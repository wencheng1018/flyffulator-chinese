...
function PetWindow({ raisedPetDefinition, petLevels, editable = false, onEditLevels = null }) {
    ...
    if (i18n.resolvedLanguage) {
        ...
        if (shortLanguageCode === 'zh') {
            shortLanguageCode = 'cns'; // Items.json中使用cns作为中文键
        }
    }
                ...
                <div id="base-container">
                    ...
                    <div id="stats-container">
                        <div className="stat-group">
                            <span className='stat-title'>品阶</span>
                            <span className='stat-value'>{Utils.getPetTierByLevels(petLevels)} 阶</span>
                        </div>

                        <div className="stat-group">
                            <span className='stat-title'>属性</span>
